...
import pyquery as p ##dependency: lxml
import os
from config import DATA_DIR

try: mendeley_cache = pickle.load(open(os.path.join(DATA_DIR, 'mendeley.cache'), 'rb')) 
except: mendeley_cache = {}
try: group_docs = pickle.load(open(os.path.join(DATA_DIR, 'tools/group_docs.pkl'), 'rb'))
